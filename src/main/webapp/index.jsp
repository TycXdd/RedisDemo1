...
<body>
    ...
    <form id="codeform">
        ...
        <font id="countdown" color="#ff4500"></font>
        <br>
        <input type="text" placeholder="填写验证码" name="verify_code">
        <button type="button" id="verifyCode">确定</button>
        <font id="result" color="#adff2f"></font><font id="error" color="#ff4500"></font>
    </form>
    ...
    $(function () {
        $("#sendCode").click(function () {
            $.post("sendCode",$("#codeform").serialize(), function (data) {
                if (data == "success") {
                    id = setInterval("refer()", 1000)//设置启动1秒定时
                } else if (data == "num") {
                    clearInterval(id);
                    t=100;
                }
